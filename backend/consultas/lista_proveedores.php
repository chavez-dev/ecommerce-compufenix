...
$query_consulta = "";
$salida = array();
$query_consulta = "SELECT * FROM lista_proveedores";

// $resultado = mysqli_query($conexion, $consulta);
// $total_rows = mysqli_num_rows($resultado);
function obtener_todo_registros(){
    include("../config/conexion.php");
    $stmt = $conexion->prepare("SELECT * FROM lista_proveedores ");
    $stmt->execute();
...
if(isset($_POST['order'])){
	...
	$query_consulta .= " ORDER BY id_proveedor DESC";
}
