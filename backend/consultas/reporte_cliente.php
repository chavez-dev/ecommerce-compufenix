...
try {
    ...
    $pdf->SetHeaderData('', 0, 'Reporte de Clientes', 'TIENDA COMPUFENIX');
    ...
    // Consultar los clientes desde la vista
    ...
    $html .= '<table border="1" cellpadding="4" cellspacing="0" style="width:100%;"> 
                <thead>
                    <tr style="background-color:#f2f2f2;">
                        ...
                        <th style="width:15%; text-align:center;">Tipo Cliente</th> <!-- Cambiar la anchura -->
    ...
    if ($stmt->rowCount() > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            $html .= '<tr>
                        ...
                        <td style="width:15%;">' . htmlspecialchars($row['tipo_cliente']) . '</td>
