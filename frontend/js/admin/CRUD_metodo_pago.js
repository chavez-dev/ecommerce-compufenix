$(document).ready(function(){
    ...
    $("#agregarEmpleado").click(function(){
        ...
        $('.modal-title').text("REGISTRO DE METODO DE PAGO");
    ...
    var dataTable = $('#tablaUsuarios').DataTable({
        ...
        "order":[],
        "ajax":{
            url: '../../../backend/consultas/listas/lista_metodo_pago.php',
            type: 'POST',
        },
        "columnDefs":[{
            "targets":[3],
    ...
    $(document).on('submit','#formulario-empleado',function(event){
        ...
        $.ajax({
            url: "../../../backend/consultas/CRUDS/CRUD_metodo_pago.php",
            method: "POST",
    ...
    $(document).on('click', '.borrar', function(){
        ...
        Swal.fire({
            ...
            text: "Estas seguro de borrar este Metodo de Pago!",
            icon: "warning",
...
function bloquearCamposYBotones() {
    $('#nombre_metodo, #descripcion, #id_metodo_pago')
        .prop('disabled', true);
