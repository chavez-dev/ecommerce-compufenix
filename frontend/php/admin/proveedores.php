...
<?php include("../../include/sidebar.php"); ?>
    ...
    <main class="main-principal">
        <div class="container-fluid">
            <button type="button" class="btn btn-success empleado-boton-agregar" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat" id="agregarEmpleado">Agregar Proveedor</button>
        </div>
