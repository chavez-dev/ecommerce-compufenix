...
<?php include("../../include/sidebar.php"); ?>
    ...
    <main class="main-principal">
        <div class="container-fluid">
            ...
            <button type="button" class="btn btn-danger" id="reporte_cliente"><i class="fa-solid fa-file-pdf" style="color: #ffffff;"></i> Reporte</button>
        </div>
...
<!-- CRUD PROVEEDOR JS -->
<script src="../../js/admin/CRUD_cliente.js"></script>
...
<script>
    ...
    seleccionarTipo.addEventListener("change", function(){
        ...
        if(tipoDocumento == 'DNI'){
            consultarDNI('cliente');
            
        } else {
            consultarRUC('cliente');
        }
    });
